 ...
 <Worksheet ss:Name="Лист2">
  <Table ss:ExpandedColumnCount="13" ss:ExpandedRowCount="81" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="72.75" ss:StyleID="s26">
    ...
    <Cell ss:MergeAcross="3">
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$item/fnf_fnd_ru:ItemNameLongML/fnf_fnd_ru:ItemNameLongML[@language='RU']"/>
        <xsl:with-param name="styleID">
          <xsl:text>s1001</xsl:text>
        </xsl:with-param>
      </xsl:call-template>
     <Data ss:Type="String">
         <xsl:value-of select="$item/fnf_fnd_ru:ItemNameLongML/fnf_fnd_ru:ItemNameLongML[@language='RU']"/>
          <!--<xsl:if test="$BI/fnf_fnd_ru:ContentUnitOfMeasure">
            <xsl:text>&#160;</xsl:text>
            <xsl:value-of select="$BI/fnf_fnd_ru:Content"/>
            <xsl:text>&#160;</xsl:text>
            <mapTo list="measurement" firstcell="code" secondcell="short_rus">
              <xsl:value-of select="$BI/fnf_fnd_ru:ContentUnitOfMeasure"/>
            </mapTo>
          </xsl:if>-->
       </Data>
     </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="35.25" ss:StyleID="s26">
    ...
    <Cell ss:MergeAcross="3">
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$BI/fnf_fnd_ru:NameOfDataSupplier"/>
        <xsl:with-param name="styleID">
          <xsl:text>s1002</xsl:text>
        </xsl:with-param>
      </xsl:call-template>
      <Data ss:Type="String">
        <xsl:value-of select="$BI/fnf_fnd_ru:NameOfDataSupplier"/>
      </Data>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="30.75" ss:StyleID="s26">
    ...
    <Cell ss:MergeAcross="3">
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$BI/fnf_fnd_ru:VAT_RU"/>
        <xsl:with-param name="styleID">
          <xsl:text>s1003</xsl:text>
        </xsl:with-param>
      </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$BI/fnf_fnd_ru:VAT_RU='59'">
          <xsl:text>0.10</xsl:text>
        </xsl:if>
       <xsl:if test="$BI/fnf_fnd_ru:VAT_RU='60'">
   ...
   <Row ss:AutoFitHeight="0" ss:Height="38.25" ss:StyleID="s26">
    ...
    <Cell>
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$BI/fnf_fnd_ru:MinimumDurabilityFromArrival"/>
        <xsl:with-param name="styleID">
          <xsl:text>s1004</xsl:text>
        </xsl:with-param>
      </xsl:call-template>
      <xsl:choose>
        <xsl:when test="$BI/fnf_fnd_ru:MinimumDurabilityFromArrival">
         <Data ss:Type="Number">
              <mapTo list="conversion" tocode="804" firstcell="code" secondcell="tocode" thirdcell="coefficient">
                <xsl:value-of select="$BI/fnf_fnd_ru:MinimumDurabilityFromArrivalTimeUnit"/>
                <xsl:text>:</xsl:text>
                <xsl:value-of select="$BI/fnf_fnd_ru:MinimumDurabilityFromArrival"/>
              </mapTo>
          </Data>
        </xsl:when>
        <xsl:otherwise>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="38.25" ss:StyleID="s26">
    ...
    <Cell ss:MergeAcross="3">
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$BI/fnf_fnd_ru:CountryOfOrigin"/>
        <xsl:with-param name="styleID">
      ...
      <Data ss:Type="String">
         <mapTo list="countries" firstcell="code" secondcell="rus">
            <xsl:value-of select="$BI/fnf_fnd_ru:CountryOfOrigin"/>
          </mapTo>
      </Data>
     </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="38.25" ss:StyleID="s26">
    ...
    <Cell ss:MergeAcross="3">
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$BI/fnf_fnd_ru:BrandNameML/fnf_fnd_ru:BrandNameML[@language='RU']"/>
        <xsl:with-param name="styleID">
          <xsl:text>s1006</xsl:text>
        </xsl:with-param>
      </xsl:call-template>
      <Data ss:Type="String">
        <xsl:value-of select="$BI/fnf_fnd_ru:BrandNameML/fnf_fnd_ru:BrandNameML[@language='RU']"/>
      </Data>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="42" ss:StyleID="s26">
    ...
    <Cell>
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$item/fnf_fnd_ru:NumberOfBaseUnitContained"/>
        <xsl:with-param name="styleID">
          <xsl:text>s1007</xsl:text>
        </xsl:with-param>
      </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:value-of select="$item/fnf_fnd_ru:NumberOfBaseUnitContained"/>
      </Data>
    </Cell>
     <Cell>
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$item/fnf_fnd_ru:NumberOfLayersPerPallet"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1007</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$item/fnf_fnd_ru:PalletDataNumberOfDespatchUnitsPerPallet and $item/fnf_fnd_ru:NumberOfLayersPerPallet">
          <xsl:value-of select="($item/fnf_fnd_ru:PalletDataNumberOfDespatchUnitsPerPallet*$item/fnf_fnd_ru:NumberOfBaseUnitContained) div $item/fnf_fnd_ru:NumberOfLayersPerPallet"/>
        </xsl:if>   
      </Data>
    </Cell>
     <Cell>
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$item/fnf_fnd_ru:PalletDataNumberOfDespatchUnitsPerPallet"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1008</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$item/fnf_fnd_ru:PalletDataNumberOfDespatchUnitsPerPallet and $item/fnf_fnd_ru:NumberOfBaseUnitContained">
          <xsl:value-of select="$item/fnf_fnd_ru:PalletDataNumberOfDespatchUnitsPerPallet*$item/fnf_fnd_ru:NumberOfBaseUnitContained"/>
        </xsl:if>
      </Data>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="45" ss:StyleID="s26">
    ...
    <Cell>
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$BI/fnf_fnd_ru:MeasurementTradeItemLengthDepth"/>
        <xsl:with-param name="styleID">
          <xsl:text>s1009</xsl:text>
        </xsl:with-param>
      </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$BI/fnf_fnd_ru:MeasurementTradeItemLengthDepth">
          <mapTo list="conversion" tocode="MMT" firstcell="code" secondcell="tocode" thirdcell="coefficient">
            <xsl:value-of select="$BI/fnf_fnd_ru:MeasurementTradeItemLengthDepthUnitOfMeasure"/>
            <xsl:text>:</xsl:text>
            <xsl:value-of select="$BI/fnf_fnd_ru:MeasurementTradeItemLengthDepth"/>
          </mapTo>
        </xsl:if>
      </Data>
    </Cell>
    <Cell>
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$item/fnf_fnd_ru:MeasurementTradeItemLengthDepth"/>
        <xsl:with-param name="styleID">
          <xsl:text>s1009</xsl:text>
        </xsl:with-param>
      </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$item/fnf_fnd_ru:MeasurementTradeItemLengthDepth">
          <mapTo list="conversion" tocode="MMT" firstcell="code" secondcell="tocode" thirdcell="coefficient">
            <xsl:value-of select="$item/fnf_fnd_ru:MeasurementTradeItemLengthDepthUnitOfMeasure"/>
            <xsl:text>:</xsl:text>
            <xsl:value-of select="$item/fnf_fnd_ru:MeasurementTradeItemLengthDepth"/>
          </mapTo>
        </xsl:if>
      </Data>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="47.25" ss:StyleID="s26">
    <Cell ss:StyleID="s290"><ss:Data ss:Type="String"
     ...
     <Cell>
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$BI/fnf_fnd_ru:MeasurementTradeItemWidth"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1009</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$BI/fnf_fnd_ru:MeasurementTradeItemWidth">
          <mapTo list="conversion" tocode="MMT" firstcell="code" secondcell="tocode" thirdcell="coefficient">
            <xsl:value-of select="$BI/fnf_fnd_ru:MeasurementTradeItemWidthUnitOfMeasure"/>
            <xsl:text>:</xsl:text>
            <xsl:value-of select="$BI/fnf_fnd_ru:MeasurementTradeItemWidth"/>
          </mapTo>
        </xsl:if>
      </Data>
    </Cell>
    <Cell>
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$item/fnf_fnd_ru:MeasurementTradeItemWidth"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1009</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$item/fnf_fnd_ru:MeasurementTradeItemWidth">
          <mapTo list="conversion" tocode="MMT" firstcell="code" secondcell="tocode" thirdcell="coefficient">
            <xsl:value-of select="$item/fnf_fnd_ru:MeasurementTradeItemWidthUnitOfMeasure"/>
            <xsl:text>:</xsl:text>
            <xsl:value-of select="$item/fnf_fnd_ru:MeasurementTradeItemWidth"/>
          </mapTo>
        </xsl:if>
      </Data>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="21.75" ss:StyleID="s26">
    <Cell ss:StyleID="s290"><ss:Data ss:Type="String"
     ...
     <Cell>
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$BI/fnf_fnd_ru:MeasurementTradeItemHeight"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1009</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$BI/fnf_fnd_ru:MeasurementTradeItemHeight">
          <mapTo list="conversion" tocode="MMT" firstcell="code" secondcell="tocode" thirdcell="coefficient">
            <xsl:value-of select="$BI/fnf_fnd_ru:MeasurementTradeItemHeightUnitOfMeasure"/>
            <xsl:text>:</xsl:text>
            <xsl:value-of select="$BI/fnf_fnd_ru:MeasurementTradeItemHeight"/>
          </mapTo>
        </xsl:if>
      </Data>
    </Cell>
     <Cell>
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$item/fnf_fnd_ru:MeasurementTradeItemHeight"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1009</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$item/fnf_fnd_ru:MeasurementTradeItemHeight">
          <mapTo list="conversion" tocode="MMT" firstcell="code" secondcell="tocode" thirdcell="coefficient">
            <xsl:value-of select="$item/fnf_fnd_ru:MeasurementTradeItemHeightUnitOfMeasure"/>
            <xsl:text>:</xsl:text>
            <xsl:value-of select="$item/fnf_fnd_ru:MeasurementTradeItemHeight"/>
          </mapTo>
        </xsl:if>
      </Data>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="21.75" ss:StyleID="s26">
    ...
    <Cell>
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$BI/fnf_fnd_ru:NetWeight"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1009</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$BI/fnf_fnd_ru:NetWeight">
          <mapTo list="conversion" tocode="GRM" firstcell="code" secondcell="tocode" thirdcell="coefficient">
            <xsl:value-of select="$BI/fnf_fnd_ru:NetWeightUnitOfMeasure"/>
            <xsl:text>:</xsl:text>
            <xsl:value-of select="$BI/fnf_fnd_ru:NetWeight"/>
          </mapTo>
        </xsl:if>
      </Data>
    </Cell>
     <Cell>
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$item/fnf_fnd_ru:NetWeight"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1009</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$item/fnf_fnd_ru:NetWeight">
          <mapTo list="conversion" tocode="GRM" firstcell="code" secondcell="tocode" thirdcell="coefficient">
            <xsl:value-of select="$item/fnf_fnd_ru:NetWeightUnitOfMeasure"/>
            <xsl:text>:</xsl:text>
            <xsl:value-of select="$item/fnf_fnd_ru:NetWeight"/>
          </mapTo>
        </xsl:if>
      </Data>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="47.25" ss:StyleID="s26">
    <Cell ss:StyleID="s305"><ss:Data ss:Type="String"
     ...
     <Cell>
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$BI/fnf_fnd_ru:GrossWeightFNFTSS"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1010</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$BI/fnf_fnd_ru:GrossWeightFNFTSS">
          <mapTo list="conversion" tocode="GRM" firstcell="code" secondcell="tocode" thirdcell="coefficient">
            <xsl:value-of select="$BI/fnf_fnd_ru:GrossWeightUnitOfMeasure"/>
            <xsl:text>:</xsl:text>
            <xsl:value-of select="$BI/fnf_fnd_ru:GrossWeightFNFTSS"/>
          </mapTo>
        </xsl:if>
      </Data>
    </Cell>
     <Cell>
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$item/fnf_fnd_ru:GrossWeightFNFTSS"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1010</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
      <Data ss:Type="Number">
        <xsl:if test="$item/fnf_fnd_ru:GrossWeightFNFTSS">
          <mapTo list="conversion" tocode="GRM" firstcell="code" secondcell="tocode" thirdcell="coefficient">
            <xsl:value-of select="$item/fnf_fnd_ru:GrossWeightUnitOfMeasure"/>
            <xsl:text>:</xsl:text>
            <xsl:value-of select="$item/fnf_fnd_ru:GrossWeightFNFTSS"/>
          </mapTo>
        </xsl:if>
      </Data>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="41.25" ss:StyleID="s334">
    ...
    <Cell ss:MergeAcross="2">
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$BI/fnf_fnd_ru:GTIN"/>
        <xsl:with-param name="styleID">
          <xsl:text>s1011</xsl:text>
        </xsl:with-param>
      </xsl:call-template>
      <Data ss:Type="Number">
       <xsl:value-of select="$BI/fnf_fnd_ru:GTIN"/>
      </Data>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="21" ss:StyleID="s29">
    ...
    <Cell ss:MergeAcross="2">
      <xsl:call-template name="markcellchanges">
        <xsl:with-param name="node" select="$item/fnf_fnd_ru:GTIN"/>
        <xsl:with-param name="styleID">
          <xsl:text>s1012</xsl:text>
        </xsl:with-param>
      </xsl:call-template>
      <Data ss:Type="String">
        <xsl:value-of select="$item/fnf_fnd_ru:GTIN"/>
      </Data>
     </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="31.5" ss:StyleID="s29">
    ...
    <Cell ss:StyleID="s418"/>
     <Cell ss:MergeAcross="1">
       <xsl:call-template name="markcellchanges">
         <xsl:with-param name="node" select="$item/fnf_fnd_ru:InternalItemIDofSupplier"/>
         <xsl:with-param name="styleID">
           <xsl:text>s1013</xsl:text>
         </xsl:with-param>
       </xsl:call-template>
       <Data ss:Type="String">
         <xsl:value-of select="$item/fnf_fnd_ru:InternalItemIDofSupplier"/>
       </Data>
     </Cell>
  ...
  <xsl:template match="/">
    <xsl:for-each select="fnf_fnd_ru:Item">
      <xsl:variable name="BI" select="fnf_fnd_ru:BaseItem/fnf_fnd_ru:BaseItemVersion[fnf_fnd_ru:GTIN='04600375040982']" />
      <xsl:variable name="BA" select="fnf_fnd_ru:Assortment/fnf_fnd_ru:AssortmentVersion[fnf_fnd_ru:GTIN='04600375040982']" />
      <xsl:if test="$BI">
        <xsl:call-template name="dataout">
          <xsl:with-param name="item" select="fnf_fnd_ru:PackagingItem/fnf_fnd_ru:PackagingItemVersion[fnf_fnd_ru:GTIN='14600375040989']"/>
