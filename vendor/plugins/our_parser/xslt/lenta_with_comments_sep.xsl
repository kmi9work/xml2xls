  ...
  <Table ss:ExpandedColumnCount="13" ss:ExpandedRowCount="81" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="72.75" ss:StyleID="s26">
    ...
    <Cell ss:MergeAcross="3">
     ...
     <Data ss:Type="String">
      ...
      <Comment ss:Author="luchal">
        <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
          <B>
            <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">ItemNameLongML[RU]</Font>
          </B>
        </ss:Data>
      </Comment>
     </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="35.25" ss:StyleID="s26">
    ...
    <Cell ss:MergeAcross="3">
      ...
      <Comment ss:Author="luchal">
        <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
          <B>
            <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">NameOfDataSupplier</Font>
          </B>
        </ss:Data>
      </Comment>
    </Cell>
    ...
    <Cell ss:StyleID="s114"><Data ss:Type="String">Ставка / КОД НДС закупка:  </Data><Comment
      ss:Author="vladimir.gorichev"><ss:Data
       xmlns="http://www.w3.org/TR/REC-html40"><B><Font html:Face="Tahoma"
         x:CharSet="238" html:Size="10" html:Color="#000000">vladimir.gorichev:</Font></B><Font
        html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">&#10;Нам важнее код НДС, который определяет ставку</Font></ss:Data></Comment></Cell>
    <Cell ss:MergeAcross="3">
      <xsl:call-template name="markcellchanges">
      ...
      <Comment ss:Author="luchal">
        <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
          <B>
            <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">if VAT_{0}='59' write 0.10;if VAT_{0}='60' write 0.18</Font>
          </B>
        </ss:Data>
      </Comment>
     </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="38.25" ss:StyleID="s26">
    ...
    <Cell>
      ...
      <Comment ss:Author="luchal">
        <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
          <B>
            <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">Конвертация MinimumDurabilityFromArrival в дни на основании MinimumDurabilityFromArrivalTimeUnit</Font>
          </B>
        </ss:Data>
      </Comment>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="38.25" ss:StyleID="s26">
    ...
    <Cell ss:MergeAcross="3">
      ...
      <Comment ss:Author="luchal">
        <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
          <B>
            <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">Маппинг стран на основе CountryOfOrigin</Font>
          </B>
        </ss:Data>
      </Comment>
     </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="38.25" ss:StyleID="s26">
    ...
    <Cell ss:MergeAcross="3">
      ...
      <Comment ss:Author="luchal">
        <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
          <B>
            <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">BrandNameML[RU]</Font>
          </B>
        </ss:Data>
      </Comment>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="39.75" ss:StyleID="s29">
    <Cell ss:StyleID="s244"><Data ss:Type="String" x:Ticked="1">Единица измерения (размещения) заказа (ЕИЗ):</Data><Comment
      ss:Author="ekaterina.zarayskaya"><ss:Data
       xmlns="http://www.w3.org/TR/REC-html40"><B><Font html:Face="Tahoma"
         x:CharSet="238" html:Size="10" html:Color="#000000">ekaterina.zarayskaya:</Font></B><Font
    ...
    <Cell ss:MergeAcross="3" ss:StyleID="m20669792"><Data ss:Type="Number"></Data><Comment
      ss:Author="luchal"><ss:Data xmlns="http://www.w3.org/TR/REC-html40"><B><Font
         html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">figure of pieces in one carton</Font></B></ss:Data></Comment></Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="41.25" ss:StyleID="s29">
    ...
    <Cell ss:MergeAcross="3" ss:StyleID="m20670248"><Data ss:Type="String">1 короб</Data><Comment
      ss:Author="luchal"><ss:Data xmlns="http://www.w3.org/TR/REC-html40"><B><Font
         html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">figure of cartons in one layer</Font></B></ss:Data></Comment></Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="42" ss:StyleID="s26">
    ...
    <Cell>
      ...
      <Comment ss:Author="luchal">
        <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
          <B>
            <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">NumberOfBaseUnitContained</Font>
          </B>
        </ss:Data>
      </Comment>
    </Cell>
     ...
     <Comment ss:Author="luchal">
        <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
          <B>
            <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">(PalletDataNumberOfDespatchUnitsPerPallet*NumberOfBaseUnitContained)/NumberOfLayersPerPallet</Font>
          </B>
        </ss:Data>
      </Comment>
    </Cell>
     <Cell>
      ...
      <Data ss:Type="Number">
       ...
       <Comment ss:Author="luchal">
         <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
           <B>
             <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">PalletDataNumberOfDespatchUnitsPerPallet*NumberOfBaseUnitContained</Font>
           </B>
         </ss:Data>
       </Comment>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="45" ss:StyleID="s26">
    ...
    <Cell>
      ...
      <Comment ss:Author="luchal">
         <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
           <B>
             <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">Конвертация MeasurementTradeItemLengthDepth в миллиметры на основе MeasurementTradeItemLengthDepthUnitOfMeasure</Font>
           </B>
         </ss:Data>
       </Comment>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="47.25" ss:StyleID="s26">
    <Cell ss:StyleID="s290"><ss:Data ss:Type="String"
     ...
     <Comment ss:Author="luchal">
       <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
         <B>
           <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">Конвертация MeasurementTradeItemWidth в миллиметры на основе MeasurementTradeItemWidthUnitOfMeasure</Font>
         </B>
       </ss:Data>
     </Comment>
    </Cell>
    ...
    <Cell ss:StyleID="s290"><ss:Data ss:Type="String"
     ...
     <Cell>
      ...
      <Comment ss:Author="luchal">
       <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
         <B>
           <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">Конвертация MeasurementTradeItemHeight в миллиметры на основе MeasurementTradeItemHeightUnitOfMeasure</Font>
         </B>
       </ss:Data>
     </Comment>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="21.75" ss:StyleID="s26">
    ...
    <Cell>
      ...
      <Comment ss:Author="luchal">
        <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
          <B>
            <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">Конвертация NetWeight в миллиметры на основе NetWeightUnitOfMeasure</Font>
          </B>
        </ss:Data>
      </Comment>
    </Cell>
     ...
     <Cell>
      ...
      <Data ss:Type="Number">
       ...
       <Comment ss:Author="luchal">
         <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
           <B>
             <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">Конвертация GrossWeightFNFTSS в миллиметры на основе GrossWeightUnitOfMeasure</Font>
           </B>
         </ss:Data>
       </Comment>
    </Cell>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="41.25" ss:StyleID="s334">
    ...
    <Cell ss:MergeAcross="2">
      ...
      <Comment ss:Author="luchal">
        <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
          <B>
            <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">GTIN</Font>
          </B>
        </ss:Data>
      </Comment>
    </Cell>
    ...
    <Cell ss:StyleID="s418"/>
     <Cell ss:MergeAcross="1">
       ...
       <Comment ss:Author="luchal">
         <ss:Data xmlns="http://www.w3.org/TR/REC-html40">
           <B>
             <Font html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">InternalItemIDofSupplier</Font>
           </B>
         </ss:Data>
       </Comment>
     </Cell>
    ...
    <Cell ss:MergeAcross="4" ss:StyleID="s47"><Data ss:Type="String">СКИДКА</Data><Comment
      ss:Author="ekaterina.zarayskaya"><ss:Data
       xmlns="http://www.w3.org/TR/REC-html40"><B><Font html:Face="Tahoma"
         x:CharSet="238" html:Size="10" html:Color="#000000">ekaterina.zarayskaya:</Font></B><Font
        html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#000000">&#10;</Font><B><Font
         html:Face="Tahoma" x:CharSet="238" html:Size="10" html:Color="#FF0000">главное - указать новую ЗЦ в руб и период ее действия для занесения в SAP </Font></B></ss:Data></Comment></Cell>
